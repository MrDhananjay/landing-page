...
const Features: React.FC = () => {
    // State to track which card is currently active (0-3)
    ...
    const getBorderClass = (index: number) => {
        return `border-gradient-mask transition-opacity duration-300 z-50 ${activeCard === index ? 'opacity-100' : 'opacity-0'}`;
    };
